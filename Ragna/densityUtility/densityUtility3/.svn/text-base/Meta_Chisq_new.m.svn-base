...
function varargout = Meta_Chisq_new(meth, varargin)
    ...
    switch meth
        ...
        case 'write'
            ...
            name(name == '.') = '_';
            name = [name '.img'];
            iimg_reconstruct_3dvol(sig_vector(:,wh), R.volInfo, 'outname', name, 'descrip', 'Created by Meta_Chisq_new.m');
            fprintf(1, 'Written: %s\n', name);
            ...
            iimg_reconstruct_3dvol(chi2dat, R.volInfo, 'outname', name, 'descrip', 'Created by Meta_Chisq_new.m');
            fprintf(1, 'Written: %s\n', name);
            ...
            if size(R.prop_by_condition, 2) == 2
                ...
                % Extent threshold
                clbvsa(cat(1, clbvsa.numVox) < 3) = [];
                clavsb(cat(1, clavsb.numVox) < 3) = [];
