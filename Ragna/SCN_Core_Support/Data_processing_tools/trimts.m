...
% function [y,ntrimmed,allw] = trimts(y,sd,X,[do spike correct],[trimming iterations])
...
% "Spikes" are IDd as values more than 10 MADs from moving average with 20 image FWHM
