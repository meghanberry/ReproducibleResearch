...
function voldata = iimg_reconstruct_vols(dat, volInfo, varargin)
    ...
    [dat volInfo] = check_dat(dat, volInfo, is_single_slice, slice_number);
...
% ------------------------------------------------------------------
function [dat volInfo] = check_dat(dat, volInfo, is_single_slice, varargin)
