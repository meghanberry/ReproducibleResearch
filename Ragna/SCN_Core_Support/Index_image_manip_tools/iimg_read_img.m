% [volInfo, dat] = iimg_read_img(inputimgs, [extended_output_flag (1|2)], [reading_data (0|1)]);
%
% volInfo fields:
...
% Data in SPM5 should be 4-D, but in SPM2 should be 3-D
%
...
function [volInfo, dat] = iimg_read_img(inputimgs, extended_output_flag, reading_data)
...
switch imgtype
    case 'name'
        ...
        %% load first image
        [volInfo, dat] = iimg_read_from_file(inputimgs(1, :), extended_output_flag, reading_data);
